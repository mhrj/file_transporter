...
for i, option in enumerate(checkbox_options):
    checkbox = tk.Checkbutton(checkbox_frame, text=option, variable=checkbox_vars[i], bg="#f0f8ff", fg="black", command=update_dropdown)
...
from_browse_button = tk.Button(folder_frame, text="Browse (from)", command=lambda: browse_folder(0), width=15, height=1, bg="#28a745", fg="black", relief="raised")
