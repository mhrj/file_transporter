...
def show_splash():
    ...
    tk.Label(splash, text="Welcome to File Transfer App", bg="#007BFF", font=("Helvetica", 16, "bold"), fg="white").pack(pady=20)
...
status_label = tk.Label(root, text="", fg="green", font=("Helvetica", 10), bg="#f0f0f0")
